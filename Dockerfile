...
ENV INSTALL_PATH /upali
# The name of the application is upali and while there
...
# having to CD into the /upali folder every time would be
# lame, so instead we can set the WORKDIR to be /upali.
#
...
# upali/ path inside of the Docker image.
#
# It copies it to /upali because of the WORKDIR being set.
#
...
# /upali folder inside of the Docker image.
#
